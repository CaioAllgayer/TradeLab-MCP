...
_LABEL_MAP = {
    ...
    "total de negociações": "total_trades",
    "total de negociacoes": "total_trades",
    "всего сделок": "total_trades",
    "retorno esperado (payoff)": "expected_payoff",
    "rebaixamento máximo do saldo": "balance_drawdown",
    "rebaixamento maximo do saldo": "balance_drawdown",
    "rebaixamento máximo do capital líquido": "equity_drawdown",
    "rebaixamento maximo do capital liquido": "equity_drawdown",
    "expert advisor (robô)": "expert",
    "expert advisor (robo)": "expert",
    "ativo": "symbol",
